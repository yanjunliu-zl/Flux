    ...
    def train(self, resume_from: str | None = None):
        ...
        while step < self.max_steps:
            ...
            if step % self.log_every == 0:
                ...
                from flux.training.distributed import all_reduce_losses
...
if __name__ == "__main__":
    # Delegate to __main__.py when run as python -m flux.training.trainer
    from flux.training.__main__ import main
    main()
