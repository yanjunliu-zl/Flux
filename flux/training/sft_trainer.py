...
from flux.training.trainer import Trainer, TrainingState
...
class SFTTrainer(Trainer):
    ...
    def sft_train_step(self, batch: dict) -> dict[str, float]:
        ...
        if self.lfa_encoder is not None and "z_id" in batch:
            from flux.models.lfa_encoder import lfa_consistency_loss
        ...
        if self.kp_encoder is not None and "z_kp" in batch:
            from flux.models.kp_encoder import kp_reconstruction_loss
