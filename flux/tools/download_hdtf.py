...
Usage:
    ...
    python -m flux.tools.download_hdtf --download_metadata --output data/hdtf/

    # Step 2: Download videos + extract clips
    python -m flux.tools.download_hdtf --max_videos 50 --output data/hdtf/ --workers 4

    # Step 3: Crop faces + generate manifest
    python -m flux.tools.ingest_talking_data --input_dir data/hdtf/clips/ --dataset hdtf --output data/manifests/hdtf_manifest.csv
"""
