...
Usage:
    ...
    python -m flux.tools.download_voxceleb --metadata_only --output data/voxceleb/

    # Download with face filtering
    python -m flux.tools.download_voxceleb --max_videos 2000 --output data/voxceleb/ --workers 4
"""
