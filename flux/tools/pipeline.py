...
Usage:
    ...
    python -m flux.tools.pipeline --source webvid --max_videos 5000

    # Full pipeline from Pexels
    export PEXELS_API_KEY="your-key"
    python -m flux.tools.pipeline --source pexels --query "nature city" --max_videos 1000

    # Process existing video directory
    python -m flux.tools.pipeline --source local --video_dir /path/to/videos
"""
...
Examples:
  ...
  # Pexels
  export PEXELS_API_KEY=your-key
  python -m flux.tools.pipeline --source pexels --max_videos 2000

  # Local videos (skip download)
  python -m flux.tools.pipeline --source local --video_dir /data/videos/
""",
    )
