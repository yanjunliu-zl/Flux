...
Usage:
    # Search and download
    python -m flux.tools.download_pexels --query "nature landscape" \
        --max_videos 1000 --output data/pexels/

    # Download from a list of URLs
    python -m flux.tools.download_pexels --url_file urls.txt --output data/pexels/
...
def main():
    ...
    print(f"Next: python -m flux.tools.quality_filter --input {args.output} --output data/filtered/")
