...
Usage:
    ...
    python -m seedance.tools.download_4k --source ultravideo --max_videos 10000

    # Pexels 4K-only
    export PEXELS_API_KEY="your-key"
    python -m seedance.tools.download_4k --source pexels_4k --max_videos 5000

    # All sources combined
    python -m seedance.tools.download_4k --source all --max_videos 20000

    # Dry run: check how many videos available without downloading
    python -m seedance.tools.download_4k --source ultravideo --dry_run
"""
...
Examples:
  ...
  python -m seedance.tools.download_4k --source all --dry_run
""",
    )
    ...
    if total > 0:
        ...
        print(f"  python -m seedance.tools.quality_filter --input {args.output} --output data/4k_filtered --min_height 2160")
        print(f"  python -m seedance.tools.build_manifest --video_dir data/4k_filtered --output data/manifests/train_4k.csv")
